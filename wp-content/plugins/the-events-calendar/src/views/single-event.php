...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<!-- PRICE -->
	<div id="price">
		<h2> Prix : <?php the_field("price"); ?> €</h2>
	</div>

	<!-- VOLUNTEERS -->
	<div id="volunteers">
		<h3>Évènement organisé par :</h3>

		<strong>Le chef : </strong>
		<ul>
			<li><?php the_field("cook"); ?></li>
		</ul>

		<br>

		<strong>Les bénévoles au bar :</strong>
		<ul>
			<?php if( get_field('bartender_1') ): ?>
				<li><?php the_field("bartender_1"); ?></li>
			<?php endif; ?>
			<?php if( get_field('bartender_2') ): ?>
				<li><?php the_field("bartender_2"); ?></li>
			<?php endif; ?>
		</ul>
	</div>
